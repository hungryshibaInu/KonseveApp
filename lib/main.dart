...
import 'package:konseve/login/login_widget.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Stream<KonseveFirebaseUser> userStream;
  KonseveFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = konseveFirebaseUserStream()
