...
Stream<List<ListsRecord>> queryListsRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(ListsRecord.collection, ListsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Future<List<ListsRecord>> queryListsRecordOnce(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(ListsRecord.collection, ListsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<FFFirestorePage<ListsRecord>> queryListsRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
}) =>
    queryCollectionPage(ListsRecord.collection, ListsRecord.serializer,
        queryBuilder: queryBuilder,
        nextPageMarker: nextPageMarker,
        pageSize: pageSize);
